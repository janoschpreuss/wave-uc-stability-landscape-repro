...
\begin{groupplot}[
   ...
   %xlabel= { $\lambda$},
    ...
    \addplot[lightgray,loosely dashdotdotted,ultra thick] 
	table[mark=none,x=deltat,y expr ={.18*\thisrowno{0}^0.4 }] {../data/Cylinder--q1-qstar1-k1-kstar1-msol2.dat}; \addlegendentry{$ \mathcal{O}(h^{0.4}) $ }%
